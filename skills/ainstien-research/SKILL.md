...
description: A stateful research companion for moving from curiosity to source-backed research output. Use when the user wants to start, continue, organize, sharpen, evaluate, experiment on, or write research across papers, web sources, notes, documents, claims, experiments, literature reviews, or AI/ML paper drafts. Especially useful for maintaining separate research states across multiple simultaneous projects, reading many sources, discussing papers, incubating ideas, planning experiments, calibrating evidence, checking research-question quality, and deciding when a project is paper-ready.
---
...
3. Update the selected journey's research state after each reading, discussion, idea, claim, experiment, or writing session.
4. Prefer next-action guidance over premature final writing.
5. Challenge weak claims, shallow novelty, broad conclusions from narrow evidence, and paper-first thinking.
...
- **Incubate ideas**: Read `references/idea-incubation.md` and use `assets/templates/idea-bank.md` when papers, discussions, confusions, or patterns spark possible research directions.
